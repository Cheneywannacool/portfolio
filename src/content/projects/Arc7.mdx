...
reflectionTitle: "Validate before you assume"
...
import ImagePair from "../../components/case-study/ImagePair.astro";
...
<ImagePair left="/images/problemdata-1.png" right="/images/problemdata-2.png" />

<DecisionList items={[
  { icon: "target", text: "Prioritized the low-hanging fruit first — resolving immediate usability bottlenecks before touching funnel length." },
  { icon: "flask", text: "Once the baseline was stabilized, set up rigorous user testing to verify whether length was actually the problem." },
]} />
...
<DecisionList items={[
  { icon: "flask", text: "Initiated A/B testing with a revised version instead of trusting perception alone." },
  { icon: "target", text: "Isolated the true impact of onboarding length from underlying usability issues." },
]} />
...
<PhoneGallery flowTitle="Onboarding in Arc7" items={[
  { src: "/images/onboarding/OB_01.png", label: "Welcome" },
  { src: "/images/onboarding/OB_02.png", label: "Social Proof" },
  { src: "/images/onboarding/OB_03.png", label: "Biological Sex" },
  { src: "/images/onboarding/OB_04.png", label: "Age" },
